    ...
    <div class="flex-1 transform -translate-y-4">
      <div class="rounded-t-2xl bg-background-light px-4 pt-4">
        <div class="flex bg-white p-1 rounded-xl shadow-sm">
          <label class="flex cursor-pointer h-10 grow items-center justify-center overflow-hidden rounded-lg px-2 has-[:checked]:bg-brand-blue has-[:checked]:text-white text-neutral-dark-gray/70 text-sm font-medium leading-normal transition-all duration-300 has-[:checked]:shadow-md">
            <span class="truncate">{{ t('journey.tabs.videos') }}</span>
            <input checked="" class="invisible w-0" name="content-toggle" type="radio" value="Farm Videos"/>
          </label>
          <label class="flex cursor-pointer h-10 grow items-center justify-center overflow-hidden rounded-lg px-2 has-[:checked]:bg-brand-blue has-[:checked]:text-white text-neutral-dark-gray/70 text-sm font-medium leading-normal transition-all duration-300 has-[:checked]:shadow-md">
            <span class="truncate">{{ t('journey.tabs.reports') }}</span>
            <input class="invisible w-0" name="content-toggle" type="radio" value="Monitoring Reports"/>
          </label>
        </div>
      </div>
